...
function Home() {
  ...
  return (
    <div className="flex flex-col bg-slate-700 rounded-none">
      ...
      <div className="rounded-t-3xl pt-5 w-screen shadow-[inset_0px_4px_13px_4px_#00000024] bg-slate-100 pb-5">
        <section className="">
          <Carrousel />
        </section>
