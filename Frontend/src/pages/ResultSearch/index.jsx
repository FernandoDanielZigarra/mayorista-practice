...
function ResultSearch() {
  ...
  return (
    <main className="flex flex-col bg-mariner-900 rounded-none w-full">
      ...
      <div className={`rounded-t-3xl pt-5 w-full shadow-[inset_0px_4px_13px_4px_#00000024] bg-slate-100 pb-5 ${results.length < 1 ? 'h-[70vh] flex justify-center items-center flex-col' : 'h-full'}`}>
        {
