...
function ProductCard({ product }) {
  return (
    ...
    <article className="h-[300px] rounded-lg border border-gray-100 bg-white shadow-md p-2 flex flex-col items-center justify-between gap-1 md:hover:scale-105 md:duration-300 md:hover:border md:hover:border-mariner-400">
